                                    ...
                                    <? if($share==1){?>
                                        <span class="pr more">
                                            ...
                                            <ul class="dropdown-menu" id="operationMenu">
                                              ...
                                              <li><a id="remove_share_link" message="请选择需要取消共享的客户" href="#removeshare-popup" title="取消客户信息的共享" class="popup-link"><i class="fa fa-share-alt"></i> 取消共享</a></li>
                                            </ul>
                                          </span>
                                    <? } ?>
                                </div>
                                ...
                                <table class="table table-bordered table-hover customer_table" id="myTable">
                                    ...
                                    <?php foreach($customer as $k=>$v){?>
                                        <tr >
                                            ...
                                            <td class="not" ><?php echo $v->linkman_mobile;?></td>
                                        ...
                                        <div class="">
                                            <div class="form-horizontal m-t">
                                               ...
                                               <div class="form-group mb10" style="">
                                                 ...
                                                 <div class="form-group nextFollow pr hide ml mr">
...
//        var arr = [];
        $('.cusMt input').click(function(event) {
            ...
            var _url="<?php echo base_url(); ?>index.php/share/my_share_customer?&status="+temp+"&will_status=<?=$_GET['will_status'] ?>&sign_status=<?=$_GET['sign_status'] ?>&tag=<?php echo $_GET['tag']; ?>&linkType=<?=$_GET['linkType'];?>&linkDay=<?=$_GET['linkDay'];?>&sortType=<?=$_GET['sortType']?>&type=<?=$_GET['type']?>&sousuo_text=<?=$_GET['sousuo_text']?>&start_time=<?=$_GET['start_time']?>&end_time=<?=$_GET['end_time']?>&share=<?=$_GET['share']?>";
            $.loadPage(_url);
        });
        ...
        $('.qianyue input').click(function(event) {
            ...
            var _url="<?php echo base_url(); ?>index.php/share/my_share_customer?&sign_status="+temp+"&will_status=<?= $_GET['will_status'] ?>&status=<?=$_GET['status'] ?>&tag=<?php echo $_GET['tag']; ?>&linkType=<?=$_GET['linkType'];?>&linkDay=<?=$_GET['linkDay'];?>&sortType=<?=$_GET['sortType']?>&type=<?=$_GET['type']?>&sousuo_text=<?=$_GET['sousuo_text']?>&start_time=<?=$_GET['start_time']?>&end_time=<?=$_GET['end_time']?>&share=<?=$_GET['share']?>";
            // alert(_url);
            $.loadPage(_url);
        });
         // 重点客户右侧查询条件
        $('.zhongdian input').click(function(event) {
            ...
            var _url="<?php echo base_url(); ?>index.php/share/my_share_customer?&will_status="+temp+"&sign_status=<?= $_GET['sign_status'] ?>&status=<?=$_GET['status']?>&tag=<?php echo $_GET['tag']; ?>&linkType=<?=$_GET['linkType'];?>&linkDay=<?=$_GET['linkDay'];?>&sortType=<?=$_GET['sortType']?>&type=<?=$_GET['type']?>&sousuo_text=<?=$_GET['sousuo_text']?>&start_time=<?=$_GET['start_time']?>&end_time=<?=$_GET['end_time']?>&share=<?=$_GET['share']?>";
            $.loadPage(_url);
        });
        // 标签分类的查询
        $('.bags li').click(function(event) {
            ...
            noCustomer ();
            var _url="<?php echo base_url(); ?>index.php/share/my_share_customer?&tag="+temp+"&will_status=<?=$_GET['will_status']; ?>&sign_status=<?=$_GET['sign_status'] ?>&status=<?php echo $_GET['status']; ?>&linkType=<?=$_GET['linkType'];?>&linkDay=<?=$_GET['linkDay'];?>&sortType=<?=$_GET['sortType']?>&type=<?=$_GET['type']?>&sousuo_text=<?=$_GET['sousuo_text']?>&start_time=<?=$_GET['start_time']?>&end_time=<?=$_GET['end_time']?>&share=<?=$_GET['share']?>";
            $.loadPage(_url);
        });
...
<script>
    $(function(){
        ...
        $("#sort_lastContactDate").click(function(){
            var _url="<?php echo base_url(); ?>index.php/share/my_share_customer?&sortType=1&will_status=<?=$_GET['will_status'] ?>&sign_status=<?=$_GET['sign_status'] ?>&tag=<?=$_GET['tag']?>&linkType=<?=$_GET['linkType'];?>&linkDay=<?=$_GET['linkDay'];?>&status=<?php echo $_GET['status']; ?>&type=<?=$_GET['type'];?>&sousuo_text=<?=$_GET['sousuo_text'];?>&start_time=<?=$_GET['start_time'];?>&end_time=<?=$_GET['end_time'];?>&share=<?=$_GET['share']?>";
            $.loadPage(_url);
        });
        $("#sort_Name").click(function(){
            var _url="<?php echo base_url(); ?>index.php/share/my_share_customer?&sortType=2&will_status=<?=$_GET['will_status'] ?>&sign_status=<?=$_GET['sign_status'] ?>&tag=<?=$_GET['tag']?>&status=<?php echo $_GET['status']; ?>&linkType=<?=$_GET['linkType'];?>&linkDay=<?=$_GET['linkDay'];?>&type=<?=$_GET['type'];?>&sousuo_text=<?=$_GET['sousuo_text'];?>&start_time=<?=$_GET['start_time'];?>&end_time=<?=$_GET['end_time'];?>&share=<?=$_GET['share']?>";
            $.loadPage(_url);
        })
        $("#sort_CreateDate").click(function(){
            var _url="<?php echo base_url(); ?>index.php/share/my_share_customer?&sortType=3&will_status=<?=$_GET['will_status'] ?>&sign_status=<?=$_GET['sign_status'] ?>&tag=<?=$_GET['tag']?>&status=<?php echo $_GET['status']; ?>&linkType=<?=$_GET['linkType'];?>&linkDay=<?=$_GET['linkDay'];?>&type=<?=$_GET['type'];?>&sousuo_text=<?=$_GET['sousuo_text'];?>&start_time=<?=$_GET['start_time'];?>&end_time=<?=$_GET['end_time'];?>&share=<?=$_GET['share']?>";
            $.loadPage(_url);
        });
...
<script>
    ...
    $(function(){
        ...
        $('.applyBtn').on('click', function(event) {
            ...
            var _url= "<?php echo base_url(); ?>index.php/share/my_share_customer?&start_time="+daterangepicker_start+"&end_time="+daterangepicker_end+"&will_status=<?=$_GET['will_status'] ?>&sign_status=<?=$_GET['sign_status'] ?>&type=<?=$_GET['type']?>&sousuo_text=<?=$_GET['sousuo_text'];?>&status=<?php echo $_GET['status']; ?>&linkType=<?=$_GET['linkType'];?>&linkDay=<?=$_GET['linkDay'];?>&sortType=<?=$_GET['sortType']?>&share=<?=$_GET['share']?>&tag=<?=$_GET['tag'];?>";
            $.loadPage(_url);
        });
        // 全选切换
        ...
        // 取消共享
        $('#remove_share_link').click(function(event) {
            var checkedInputs1 = $(".tdClass input:checked");
            var cus_id="";
            for(var i = 0; i < checkedInputs1.size(); i++) {
                cus_id += checkedInputs1[i].value + ",";
            ...
            if (cus_id) {
                $.post('<?=base_url(); ?>index.php/share/cancel_share',{'cus_id':cus_id}, function(data) {
                    if (data) {
                        showInfo('已经取消了'+checkedInputs1.size()+'个客户的共享信息',"success");
                        var _url = '<?=base_url(); ?>index.php/share/my_share_customer?&share=1';
                        $.loadPage(_url);
                    };
                });
            }else{
                showInfo("请勾选您要取消共享的客户","error");
            }
        });
    });
